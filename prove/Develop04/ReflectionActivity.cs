...
{
    string [] _prompts = {"Think of a time when you did something really difficult.", "Think of a time when you did something truly selfless.", "Think about a time when someone hurt you."};
